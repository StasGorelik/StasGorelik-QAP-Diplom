...
class DashboardPage(BasePage):
    ...
    def __init__(self, page: Page):
        ...
        self.dashboard_create_board_button = self.page.locator('[data-qa="dashboard-create-board-button"]')    
        self.brand_title = self.page.locator('.brand-title')
        self.header_username = self.page.locator('[data-qa="header-username"]').filter(has_text="bob_user")
        self.header_user_dropdown_info = self.page.locator('.header-user-dropdown-info')
        self.header_logout_button = self.page.locator('[data-qa="header-logout-button"]')
